---
description: Review a Salesforce DX project for code, metadata, security, and deployment risks.
---

# Task

Review the Salesforce DX project in this repository.
...
3. Inspect repo structure, changed files, Apex, Flow, LWC, permissions, and deployment risk.
