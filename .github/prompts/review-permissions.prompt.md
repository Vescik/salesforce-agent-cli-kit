---
description: Review Salesforce permissions and security metadata.
---

# Task

Review permission and security impact in this Salesforce DX project.
...
3. Inspect permission sets, profiles if present, Apex access, CRUD/FLS assumptions, sharing, custom permissions, and guest/community risks.
