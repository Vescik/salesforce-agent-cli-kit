---
description: Create a Lightning Web Component with safe data access and error handling.
---

# Task

Create an LWC for the supplied requirement.
...
3. Inspect existing LWC patterns, choose LDS/wire/imperative Apex, implement loading/error states, and avoid hardcoded org assumptions.
