---
description: Review an Apex class for bulk safety, security, tests, and maintainability.
---

# Task

Review the requested Apex class or infer likely target from the user request.
...
3. Inspect classes and related tests, check SOQL/DML loops, sharing, CRUD/FLS, hardcoded IDs, and assertions.
