---
description: Plan safe Salesforce metadata retrieval without overwriting local work.
---

# Task

Plan metadata retrieval for the requested components.
...
3. Inspect repo state, warn about overwrite risk, prefer preview/diff, and require approval before mutating local files.
