---
description: Create an Apex service class following existing project conventions.
---

# Task

Create an Apex service for the supplied requirement.
...
3. Inspect existing architecture, choose service/selector/handler pattern, implement bulk-safe code, and add tests if requested.
