---
description: Create or improve Apex tests for a class, trigger, or service.
---

# Task

Create Apex tests for the requested behavior.
...
3. Inspect existing test factories, create bulk and negative tests, avoid SeeAllData, and include meaningful assertions.
