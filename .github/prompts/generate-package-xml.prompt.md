---
description: Generate or review a package.xml for modified Salesforce metadata.
---

# Task

Generate a package.xml for the requested metadata set.
...
3. Inspect changed files and metadata paths, infer metadata members, and create or suggest manifest entries.
