---
description: Review a Salesforce Flow XML file for safety, scalability, and correctness.
---

# Task

Review Salesforce Flow metadata in this repository.
...
3. Inspect Flow XML for object, trigger type, timing, decisions, gets, DML, loops, subflows, Apex actions, fault paths, recursion, and bulk behavior.
