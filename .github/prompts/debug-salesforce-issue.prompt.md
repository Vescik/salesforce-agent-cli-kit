---
description: Debug a Salesforce issue using repository and CLI evidence.
---

# Task

Diagnose the reported Salesforce issue.
...
3. Inspect logs or errors supplied by the user, locate related metadata, classify probable causes, and propose minimal fixes.
