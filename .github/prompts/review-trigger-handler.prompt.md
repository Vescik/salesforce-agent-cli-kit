---
description: Review an Apex trigger or trigger handler.
---

# Task

Review the requested trigger and handler pattern.
...
3. Inspect trigger context, handler delegation, recursion controls, bulk tests, and order-of-execution risk.
