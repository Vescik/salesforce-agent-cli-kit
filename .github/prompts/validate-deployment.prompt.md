---
description: Validate Salesforce deployment readiness without deploying.
---

# Task

Prepare and run safe validation for changed Salesforce metadata.
...
3. Inspect changed metadata, package.xml, test requirements, org aliases, and run validate-only commands only when appropriate.
